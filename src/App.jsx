          ...
          <div className="about-main">
            ...
            <div className="about-highlights">
              <div className="highlight-card">
                ...
                <p>Python, Django, React, and modern JavaScript workflows.</p>
              </div>
              <div className="highlight-card">
                <h4>Engineering Mindset</h4>
                <p>Reliable systems with clear architecture and testing.</p>
              </div>
              <div className="highlight-card">
                <h4>User-Centered</h4>
                <p>Clean UI, accessibility, and responsive delivery.</p>
              </div>
            </div>
          </div>
